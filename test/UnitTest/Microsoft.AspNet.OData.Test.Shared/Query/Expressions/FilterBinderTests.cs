...
#region Inequalities
        ...
        public void DateTimeOffsetInEqualities(string clause, string expectedExpression)
        {
            ...
            ExceptionAssert.Throws<ODataException>(() => Bind("" + clause), allowDerivedExceptions: true);
...
#region cast in query option
        ...
        {
            // Arrange & Act & Assert
            ExceptionAssert.Throws<ODataException>(() => Bind<DataTypes>(filter), errorMessage, allowDerivedExceptions: true);
        }
