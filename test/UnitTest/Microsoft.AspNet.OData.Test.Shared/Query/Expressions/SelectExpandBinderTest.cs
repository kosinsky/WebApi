...
namespace Microsoft.AspNet.OData.Test.Query.Expressions
{
    public class SelectExpandBinderTest
    {
        ...
        public SelectExpandBinderTest()
        {
            ...
            _binder.QueryProvider = _queryable.Provider;
        }
        ...
        [Theory(Skip = "7.6.2 compat issues?")]
        ...
        [Theory(Skip = "7.6.2 compat issue?")]
        ...
        public void GetSelectExpandProperties_FoSelectAndExpand_ReturnsCorrectExpandedProperties()
        {
            ...
            // TODO: Revert back to 6 when () PBI compat is fixed
            Assert.Equal(8, selectExpandClause.SelectedItems.Count());
        ...
        public void CreatePropertyValueExpression_NonDerivedNavigationProperty_ReturnsMemberAccessExpression(string property)
        {
            ...
            // Act
            Expression propertyValue = _binder.CreatePropertyValueExpression(_customer, navProperty, source);
        ...
        public void CreatePropertyValueExpression_DerivedNavigationProperty_ReturnsPropertyAccessExpression(string property)
        {
            ...
            // Act
            Expression propertyValue = _binder.CreatePropertyValueExpression(_customer, specialProperty, source);
        ...
        public void CreatePropertyValueExpression_DerivedValueProperty_ReturnsPropertyAccessExpression(string property)
        {
            ...
            // Act
            Expression propertyValue = _binder.CreatePropertyValueExpression(_customer, edmProperty, source);
        ...
        public void CreatePropertyValueExpression_HandleNullPropagationTrue_AddsNullCheck()
        {
            ...
            // Act
            Expression property = _binder.CreatePropertyValueExpression(_customer, idProperty, source);
        ...
        public void CreatePropertyValueExpression_Collection_ThrowsODataException_IfMappingTypeIsNotFoundInModel()
        {
            ...
            ExceptionAssert.Throws<ODataException>(
                () => _binder.CreatePropertyValueExpressionWithClauses(_customer, ordersProperty, source, expandItem.FilterOption, null, null),
        ...
        public void CreatePropertyValueExpression_Collection_Works_HandleNullPropagationOption(HandleNullPropagationOption nullOption)
        {
            ...
            // Act
            var filterInExpand = _binder.CreatePropertyValueExpressionWithClauses(_customer, ordersProperty, source, expandItem.FilterOption, null, null);
        ...
        [Fact]
        public void CreatePropertyValueExpressionWithClauses_Collection_WorksWithApply()
        {
            // Arrange
            _model.SetAnnotationValue(_order, new ClrTypeAnnotation(typeof(QueryOrder)));
            var customer =
        ...
        public void CreatePropertyValueExpressionWithClauses_Collection_WorksWithApplyAndFilter(string apply, string filter)
        {
            ...
            Assert.Equal(
                string.Format(
                    ...
                    "{{Container = new LastInChain() {{Name = \"Count\", Value = Convert(Convert($it, IEnumerable`1).LongCount(), Object)}}}}).AsQueryable()" +
            ...
            Assert.Equal(
                string.Format(
                    "value({0}).Orders.AsQueryable()" +
                    ".GroupBy($it => new NoGroupByWrapper()).Select($it => new NoGroupByAggregationWrapper() " +
                    "{{Container = new LastInChain() {{Name = \"Count\", Value = Convert(Convert($it).LongCount())}}}}).AsQueryable()" +
        ...
        public void CreatePropertyValueExpressionWithFilter_Single_ThrowsODataException_IfApplyUsed()
        {
            ...
            // Act & Assert
            ExceptionAssert.Throws<ODataException>(
                () => _binder.CreatePropertyValueExpressionWithClauses(_order, customerProperty, order, filterClause: null, applyClause: applyClause, computeClause: null),
        ...
        public void CreatePropertyValueExpressionWithFilter_Single_ThrowsODataException_IfMappingTypeIsNotFoundInModel()
        {
            ...
            // Act & Assert
            ExceptionAssert.Throws<ODataException>(
                () => _binder.CreatePropertyValueExpressionWithClauses(_order, customerProperty, source, expandItem.FilterOption, null, null),
        ...
        public void CreatePropertyValueExpression_Single_Works_IfSettingIsOff()
        {
            ...
            // Act 
            var filterInExpand = _binder.CreatePropertyValueExpressionWithClauses(_order, customerProperty, order, expandItem.FilterOption, null, null);
        ...
        public void CreatePropertyValueExpression_Single_Works_HandleNullPropagationOption(HandleNullPropagationOption nullOption)
        {
            ...
            // Act
            var filterInExpand = _binder.CreatePropertyValueExpressionWithClauses(_order, customerProperty, source, expandItem.FilterOption, null, null);
