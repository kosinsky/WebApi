...
namespace Microsoft.AspNet.OData.Test
{
    public class SelectExpandTest
    {
        ...
        [Fact]
        public async Task AutoSelectDoesntAddToContext()
        {
            // Arrange
        ...
        [Fact]
        public async Task ExplicitSelectHasPriorityToAutoSelect()
        {
            // Arrange
        ...
        [Fact]
        public async Task AutoSelectDoesntAddToContextForExpanded()
        {
            // Arrange
            ...
            Assert.Equal(HttpStatusCode.OK, response.StatusCode);
            JObject result = JObject.Parse(response.Content.ReadAsStringAsync().Result);
            Assert.Equal("http://localhost/odata-autoselect/$metadata#SelectExpandTestCustomers(Orders,Orders())", result["@odata.context"]);
        }

        [Fact]
        public async Task ExplicitSelectInExpandHasPriorityToAutoSelect()
        {
            // Arrange
            ...
            Assert.Equal(HttpStatusCode.OK, response.StatusCode);
            JObject result = JObject.Parse(response.Content.ReadAsStringAsync().Result);
            Assert.Equal("http://localhost/odata-autoselect/$metadata#SelectExpandTestCustomers(Orders,Orders(ID))", result["@odata.context"]);
        }
