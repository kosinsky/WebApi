...
namespace Microsoft.AspNet.OData.Query.Expressions
{
    ...
    internal class SelectExpandBinder
    {
        ...
        private object Bind(object entity, SelectExpandQueryOption selectExpandQuery)
        {
            ...
            LambdaExpression projectionLambda = GetProjectionLambda(source, selectExpandQuery);
        ...
        private LambdaExpression GetProjectionLambda(ParameterExpression source, SelectExpandQueryOption selectExpandQuery)
        {
            //Type elementType = selectExpandQuery.Context.ElementClrType;
        ...
        [SuppressMessage("Microsoft.Maintainability", "CA1506:AvoidExcessiveClassCoupling", Justification = "Class coupling acceptable")]
        internal Expression CreatePropertyValueExpressionWithClauses(IEdmStructuredType elementType, IEdmProperty property, Expression source, FilterClause filterClause, ApplyClause applyClause, ComputeClause computeClause)
        {
            Contract.Assert(elementType != null);
            Contract.Assert(property != null);
            Contract.Assert(source != null);
        ...
        internal Expression ProjectElement(Expression source, SelectExpandClause selectExpandClause, IEdmStructuredType structuredType, IEdmNavigationSource navigationSource)
        {
            ...
            if (selectExpandClause != null)
            {
                ...
                bool isContainDynamicPropertySelection = GetSelectExpandProperties(_model, structuredType, navigationSource, selectExpandClause, InputCollapsed,
                ...
                if (propertiesToExpand != null || propertiesToInclude != null || autoSelectedProperties != null || isSelectingOpenTypeSegments)
                {
                    Expression propertyContainerCreation =
                        BuildPropertyContainer(source, structuredType, propertiesToExpand, propertiesToInclude, autoSelectedProperties, dynamicProperties, isSelectingOpenTypeSegments);
        ...
        /// <param name="inputCollapsed">$select is applied after $apply with groupby/aggregate.</param>
            ...
            out ISet<IEdmStructuralProperty> autoSelectedProperties)
        {
            ...
            if (!IsSelectAll(selectExpandClause) && !inputCollapsed)
            {
            ...
            bool isSelectingOpenTypeSegments)
        {
            ...
            if (autoSelectedProperties != null)
            {
                foreach (IEdmStructuralProperty propertyToInclude in autoSelectedProperties)
                {
                    ...
                    Expression propertyValue = CreatePropertyValueExpressionWithClauses(structuredType, propertyToInclude, source, filterClause: null, applyClause: null, computeClause: null);
            ...
            if (dynamicProperties != null && FlattenedPropertyContainer != null)
            {
            ...
            IList<NamedPropertyExpression> includedProperties)
        {
            ...
            Expression propertyValue = CreatePropertyValueExpressionWithClauses(structuredType, navigationProperty, source, expandedItem.FilterOption, expandedItem.ApplyOption, expandedItem.ComputeOption);
            ...
            IList<NamedPropertyExpression> includedProperties)
        {
            ...
            {
                propertyValue = CreatePropertyValueExpressionWithClauses(structuredType, structuralProperty, source, filterClause: null, applyClause: null, computeClause: null);
                includedProperties.Add(new NamedPropertyExpression(propertyName, propertyValue));
                return;
            }
            ...
            propertyValue = CreatePropertyValueExpressionWithClauses(structuredType, structuralProperty, source, pathSelectItem.FilterOption, applyClause: null, computeClause: null);
