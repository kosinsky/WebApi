...
namespace Microsoft.AspNet.OData.Query.Expressions
{
    ...
    public abstract partial class ExpressionBinderBase
    {
        ...
        /// <summary>
        /// In case of open Edm proeprties (generated by in $apply) with different CLR types promote smaller type to wider one.
        /// For example, int could we converted to long, decimal and double.
        /// </summary>
        /// <param name="binaryOperatorNode"></param>
        /// <param name="left"></param>
        /// <param name="right"></param>
        private static void PromoteExpressionTypes(BinaryOperatorNode binaryOperatorNode, ref Expression left, ref Expression right)
        {
            Type leftType = TypeHelper.GetUnderlyingTypeOrSelf(left.Type);
            Type rightType = TypeHelper.GetUnderlyingTypeOrSelf(right.Type);
            if (leftType != rightType && binaryOperatorNode.Left.TypeReference == null && binaryOperatorNode.Right.TypeReference == null)
            {
