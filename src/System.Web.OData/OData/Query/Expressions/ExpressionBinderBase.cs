...
namespace System.Web.OData.Query.Expressions
{
    ...
    public abstract class ExpressionBinderBase
    {
        ...
        /// <summary>
        /// In case of open Edm proeprties (generated by in $apply) with different CLR types promote smaller type to higher one.
        /// </summary>
        ...
        private static void PromoteExpressionTypes(BinaryOperatorNode binaryOperatorNode, ref Expression left, ref Expression right)
        {
            ...
            if (leftType != rightType && binaryOperatorNode.Left.TypeReference == null && binaryOperatorNode.Right.TypeReference == null)
            {
                ...
                if (rightType.CanPromoteValueTypeTo(leftType))
                {
